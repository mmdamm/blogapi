...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image_file', models.ImageField(height_field=200, upload_to='post_images/', width_field=200)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['created'], name='blog_imageb_created_02b67d_idx'),
        ),
        migrations.AddIndex(
            model_name='comment',
